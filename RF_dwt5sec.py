# -*- coding: utf-8 -*-
"""
Created on Sun May 26 17:40:12 2024
...
rf_classifier = RandomForestClassifier(n_estimators=120, max_depth=20, min_samples_split=2, min_samples_leaf=1, random_state=42)
