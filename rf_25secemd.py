# -*- coding: utf-8 -*-
"""
Created on Fri May 24 16:34:54 2024
...
# Read the data
data = pd.read_csv('increasedemd25.csv')
...
rf_classifier = RandomForestClassifier(n_estimators=120, max_depth=10, min_samples_split=5, min_samples_leaf=1, random_state=42)
